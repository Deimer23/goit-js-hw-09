...
function createPromise(position, delay) {
    ...
    promise.then(({ position1 , delay1  })=>{
        (0, _notiflixDefault.default).Notify.success(`✅ Fulfilled promise ${position1} in ${delay1}ms`);
    }).catch(({ position1 , delay1  })=>{
        (0, _notiflixDefault.default).Notify.failure(`❌ Rejected promise ${position1} in ${delay1}ms`);
    });
}
